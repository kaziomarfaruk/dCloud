    ...
    <div class="">
        ...
        while($row = mysqli_fetch_assoc($result)){ ?>
            ...
            <?php if(explode('/',$row["type"])[0] == 'image'){ ?>
                <li >
                    <a href="{{$row["path"]}}" style="text-decoration: none">
                        <img src="{{$row["path"]}}" style="padding: 10px;border-radius: 20%" width="150" height="130">
                        <h4 class="lightSlider-h" style="margin-left: 20px">{{substr($row["file_name"],0,8)}}.{{$row["ext"]}}</h4>
                    </a>
                </li>
            <?php } ?>
            ...
            <?php if($row["type"] == 'folder'){ ?>
                <li>
                    <a href="/folder/{{$row["id"]}}" style="text-decoration: none">
                        <img src="/assets/blog/img/others/folder-big.png" style="padding: 10px;border-radius: 20%" width="150" height="130">
                        <h4 class="lightSlider-h" style="margin-left: 20px">{{substr($row["file_name"],0,8)}}</h4>
                    </a>
                </li>
            <?php  } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="/file/rename">
                    <input class="form-control" type="text" name="new_name" value="{{$row["file_name"]}}" placeholder="Rename file">
...
<!-- Share Modal -->
<div class="modal fade" id="ShareModal{{$row["id"]}}" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
