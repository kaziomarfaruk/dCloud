        ...
        <div class="mb-3 text-center">
            ...
            <div class="col-md-4 card mb-4 box-shadow">
                ...
                <div style="padding:20px">
                    <h1 class="pricing-card-title">${{$row['price']}} <small class="text-muted">/ mo</small></h1>
                    ...
                    <a style="text-decoration: none" href="/upgrade/action/{{$row['storage']}}"><button type="button" class="btn btn-lg btn-block btn-primary">Get started</button></a>
                </div>
            </div>
