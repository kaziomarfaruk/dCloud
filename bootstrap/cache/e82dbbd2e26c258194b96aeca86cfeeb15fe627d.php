<?php $__env->startSection('blog'); ?>
    ...
    <div class="container">
        ...
        <div class="mb-3 text-center">
            ...
            $query = mysqli_query($RawConnect,'SELECT * FROM storage_policy order by price asc');
            ...
            <div class="col-md-4 card mb-4 box-shadow">
                ...
                <div style="padding:20px">
                    <h1 class="pricing-card-title">$<?php echo e($row['price']); ?> <small class="text-muted">/ mo</small></h1>
                    ...
                    <a style="text-decoration: none" href="/upgrade/action/<?php echo e($row['storage']); ?>"><button type="button" class="btn btn-lg btn-block btn-primary">Get started</button></a>
                </div>
            </div>
