            ...
            <div class="form-inline">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/share/<?php echo e($_SESSION['LoggedUserId']); ?>/<?php echo e($_SESSION['LoggedUserSalt']); ?>">Public Share</a></li>

                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/private/share/<?php echo e($_SESSION['LoggedUserId']); ?>">Shared With Me</a></li>
        ...
        <div class="col-sm-2 hidden-xs">
            <div id="tree">
                ...
                <ul class="list-unstyled">
                    <div class="div_hover">
                        <li style="">
                            <a href="/share/<?php echo e($_SESSION['LoggedUserId']); ?>/<?php echo e($_SESSION['LoggedUserSalt']); ?>" style="margin: 0 auto;text-decoration: none" class="clickable folder-item" data-id="/shares">
                ...
                <ul class="list-unstyled">
                    <div class="div_hover">
                        <li style="">
                            <a href="/private/share/<?php echo e($_SESSION['LoggedUserId']); ?>" style="margin: 0 auto;text-decoration: none" class="clickable folder-item" data-id="/shares">
                ...
                <?php
                    ...
                    <p class=""><i style="font-size: 20px" class="material-icons">storage</i> <span class="left-menu-text" >Storage used</span> <span class="text-primary pull-right"><b><?php echo e($percent); ?>%</b></span></p>
                    <div class="progress">
                        <div class="progress-bar progress-bar-primary " role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($percent); ?>%;">
                        </div><!-- /.progress-bar .progress-bar-danger -->
                    </div>
                    <small>Used <?php echo e($used); ?> of <?php echo e($total); ?></small>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <form action="\upload\action" method="POST" enctype="multipart/form-data">
                                <input class="form-control" type="hidden" name="parent_id" value="<?php echo e($parent_id); ?>">
