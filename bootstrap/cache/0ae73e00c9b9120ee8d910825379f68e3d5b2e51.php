        ...
        <div id="result"></div>
            ...
            <br><br>
              ...
              <div class="form-group">
                    ...
                    <input style="width: 500px" id="copyTarget" readonly type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="http://dcloud.com/share/<?php echo e($_SESSION['LoggedUserId']); ?>/<?php echo e($_SESSION['LoggedUserSalt']); ?>" >
                </div>
