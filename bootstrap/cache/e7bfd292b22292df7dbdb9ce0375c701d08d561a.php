        ...
        <div style="width:400px;margin:0px auto">
            <div style=" background: #ffffff;border-top: 2px solid #d9d9d9 " class="account-wall">
                ...
                <?php if(isset($_SESSION['UserAlreadyExists'])){ ?>
                    <p class="lead" style="text-align: center;font-size: 12px;padding: 5px"><?php echo e($_SESSION['UserAlreadyExists']); ?></p><br>
                    <?php unset($_SESSION['UserAlreadyExists']); ?>
                <?php  } ?>

                <?php if(isset($_SESSION['PasswordDidnotMatched'])){ ?>
                    <p class="lead" style="text-align: center;font-size: 12px;padding: 5px"><?php echo e($_SESSION['PasswordDidnotMatched']); ?></p><br>
